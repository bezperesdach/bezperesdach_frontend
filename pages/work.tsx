  ...
  return (
    <UnauthorizedUserLayout>
      <SEO
        ...
        description="Как зарабатывать не выходя из дома? Стань автором на “Без пересдач”! Получай стабильный заработок удаленно, помогай студентам и делай мир лучше!"
